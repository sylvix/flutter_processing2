...
class ImageBlendSketchDemo extends StatefulWidget {
  const ImageBlendSketchDemo({
    Key? key,
  ...
  @override
  _ImageBlendSketchDemoState createState() => _ImageBlendSketchDemoState();
}

class _ImageBlendSketchDemoState extends State<ImageBlendSketchDemo> {
  late PImage _image1;
  late PImage _image2;
  late PImage _image3;
