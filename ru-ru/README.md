...
| Feature                                     | Description                                           |
|---------------------------------------------|-------------------------------------------------------|
| [`dist()`](ru-ru/math/calculations/dist.md) | Вычисляет расстояние между двумя точками.             |
| [`lerp()`](ru-ru/math/calculations/lerp.md) | Вычисляет число между двумя числами с заданным шагом. |
| [`map()`](ru-ru/math/calculations/map.md)   | Преобразует число из одного диапазона в другой.       |
